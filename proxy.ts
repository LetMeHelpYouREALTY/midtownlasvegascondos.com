...
export const config = {
  matcher: [
     ...
     */
    '/((?!api|_next/static|_next/image|favicon.ico|robots.txt|sitemap\\.xml|\\.well-known/workflow|google[a-z0-9]+\\.html|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|xml|txt|json|woff2?)$).*)',
  ],
}
