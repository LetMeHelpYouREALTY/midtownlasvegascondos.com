...
export const metadata: Metadata = {
  ...
  description:
    'Contact Dr. Jan Duffy for Midtown Las Vegas condos and homes. Call (702) 500-1955 or email DrJanSells@MidtownVegasCondos.com. Schedule your personal tour today!',
  keywords:
